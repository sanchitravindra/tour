...
public class austriaadapter extends PagerAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    /**
     * here i added images and text
     */
    private Integer[] images1 = {R.drawable.hallstatt2, R.drawable.hallstatt1, R.drawable.hallstat3};
    private Integer[] strings1 = {R.string.austria};

    public austriaadapter(Context context) {
